...
/**
 * Constants for the HTTP specification
 */
public class HTTP {
  ...
  public static final String HDR_ACCESS_CONTROL_ALLOW_ORIGIN = "Access-Control-Allow-Origin";
  public static final String HDR_AGE = "Age";
  public static final String HDR_ALLOW = "Allow";
  public static final String HDR_ALT_SVC = "Alt-Svc";
  ...
  public static final String HDR_FORWARDED = "Forwarded";
  ...
  public static final String HDR_PUBLIC_KEY_PINS = "Public-Key-Pins";
  ...
  public static final String HDR_TSV = "TSV";
