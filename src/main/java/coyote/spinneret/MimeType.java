...
public class MimeType {
   ...
   */
  public static void add(final String extension, final String type, final boolean binary) {
    synchronized (MIMES) {
   ...
   */
  public static List<MimeType> get(final String fileName) {
    synchronized (MIMES) {

      final List<MimeType> retval = new ArrayList<MimeType>();
   ...
   * @param extension Not blank extension without the delimiting dot (e.g. "html")
   */
  public static void remove(final String extension) {
    synchronized (MIMES) {
      if (StringUtil.isNotBlank(extension)) {
        final String ext = extension.trim().toLowerCase();

        final ListIterator<MimeType> iter = MIMES.listIterator();
        while (iter.hasNext()) {
  ...
  public boolean equals(final Object obj) {
    return obj != null && obj instanceof MimeType && getType().equals(((MimeType) obj).getType());
  }
  ...
  public String toString() {
    final StringBuffer b = new StringBuffer("MIME: ");
    b.append(extension);
    b.append(" : ");
    b.append(type);
    b.append(" : ");
