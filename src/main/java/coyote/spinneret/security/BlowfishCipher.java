...
public class BlowfishCipher extends AbstractCipher implements Cipher {
  public static final String CIPHER_NAME = "BlowFish";
   ...
   * The hex digits of pi, arranged as four s_boxes & one Pi array, as per the
   * Blowfish default. These have passed muster w/ Eric Young's set of test
   * vectors.
   */
   ...
   *
   * <p>The key bytes are first extracted from the user-key and then used,
