...
class HTTPSessionImpl implements HTTPSession {
   ...
   * @param secured
   */
  public HTTPSessionImpl(HTTPD httpd, final CacheManager cacheManager, final InputStream inputStream, final OutputStream outputStream, boolean secured) {
    this.httpd = httpd;
   ...
   */
  public HTTPSessionImpl(HTTPD httpd, final CacheManager cacheManager, final InputStream inputStream, final OutputStream outputStream, final InetAddress inetAddress, final int port, boolean secured) {
  ...
  /**
   * @see coyote.spinneret.HTTPSession#execute()
   */
  @Override
  public void execute() throws IOException {
    ...
    try {
      ...
      final byte[] buf = new byte[HTTPSessionImpl.BUFSIZE];
      splitbyte = 0;
      rlen = 0;

      int read = -1;
      inputStream.mark(HTTPSessionImpl.BUFSIZE);
      try {
        read = inputStream.read(buf, 0, HTTPSessionImpl.BUFSIZE);
      ...
      while (read > 0) {
        ...
        read = inputStream.read(buf, rlen, HTTPSessionImpl.BUFSIZE - rlen);
      }
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getRequestHeaders()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getResponseHeaders()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getRemoteIpAddress()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getRemoteIpPort()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getUserName()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#setUserName(String)
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#getUserGroups()
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#setUserGroups(List)
   */
  @Override
  ...
  /**
   * @see coyote.spinneret.HTTPSession#isSecure()
   */
  @Override
