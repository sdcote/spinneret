...
import coyote.spinneret.security.BlowfishCipher;
import coyote.spinneret.security.Cipher;
import coyote.spinneret.security.NullCipher;
import coyote.spinneret.security.XTEACipher;
...
public class CipherUtil {
  ...
  public static String encryptString(String clearText) {
    String retval = null;
    String key = System.getProperty(Spinneret.CIPHER_KEY, CipherUtil.getKey(CIPHER_KEY));
    String cipherName = System.getProperty(Spinneret.CIPHER_NAME, CIPHER_NAME);
  ...
  public static String decipher(final String cipherText, final Cipher cipher, final int saltSize, final byte[] key) {
    ...
    String retval = null;
    retval = new String(data, StandardCharsets.UTF_16);
  ...
  public static String encipher(final String text, final Cipher cipher, final byte[] salt, final byte[] key) {
    ...
    if (text != null) {
      textbytes = text.getBytes(StandardCharsets.UTF_16);
    } else {
